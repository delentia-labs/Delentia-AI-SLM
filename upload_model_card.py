...
def main():
    ...
    if not token:
        print(
            "ERROR: Set HF_TOKEN environment variable first or "
    ...
    REPO_ID = "Ittirit-delentia/delentia-slm-jitna-v0.2"
    REPO_ID_ORG = "Delentia/delentia-slm-jitna-v0.2"
    api = HfApi()
    ...
    for repo_id in [REPO_ID, REPO_ID_ORG]:
        ...
        api.upload_file(
            ...
            repo_id=repo_id,
            repo_type="model",
            commit_message="feat: upload JITNA v0.2 TOON model card",
        )
